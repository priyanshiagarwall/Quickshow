  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
      ...
      <div className='relative mt-6 max-w-[960px] mx-auto'>
        ...
        {/* This is the responsive container for the ReactPlayer */}
        <div className="relative pt-[56.25%]"> {/* pt-[56.25%] creates a 16:9 aspect ratio */}
          <ReactPlayer
            url={currentTrailer.videoUrl}
            // Temporarily set controls to true for easy debugging.
            // You can change this back to false once the player is working as expected.
            controls={true}
